...
import { TouchableOpacity, View, StyleSheet, Text, Platform, Image } from "react-native";
...
export default function TimeDataPicker({
    ...
    const onChange = (_ , selectDate) => {
        ...
        const notificaitonMin = tempDate.getMinutes().toString().padStart(2, "0")
        let dateNotification;

        if(frequency === "Semanal"){
            dateNotification = selected
        }
        const timeNotification = `${notificationHour}:${notificaitonMin}`
